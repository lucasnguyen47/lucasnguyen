  ...
  const experiences = [
    {
      ...
      type: "Fulltime",
      description:
        "Thiết kế đồ hoạ quang cáo, ấn phẩm, nhận diện thương hiệu, bao bì sản phẩm, giao diện người dùng tai AMC Mekong",
    },
    {
      year: "2018",
      ...
      type: "Fulltime",
      description:
        "Vận hành và phát triển nhận diện thương hiệu và các ấn phẩm quảng cáo, lập chiến lược truyền thông thị trường, quản lý đội nhóm thiết kế tại PNF JSC",
    },
    {
      year: "2021",
      title: "Senior Designer",
      ...
      type: "Remote",
      description:
        "Vận hành và phát triển nhận diện thương hiệu, phát triển các ấn phẩm quảng cáo, lập chiến lược truyền thông thị trường, quản lý đội nhóm thiết kế",
    },
    {
      year: "2022+",
      ...
      type: "Freelancer",
      description:
        "Cung cấp các dịch vụ thiết kế đồ hoạ đa dạng bao gồm nhận diện thương hiệu, đồ hoạ quảng cáo, ấn phẩm, 3D và giao diện người dùng cho các khách hàng cá nhân và doanh nghiệp.",
    },
  ];
